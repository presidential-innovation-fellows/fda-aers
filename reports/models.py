...
class Report(models.Model):
    ...
    ## A.1.5 Seriousness
    serious = models.NullBooleanField("If any serious criteria are identified")
    seriousnessdeath = models.BooleanField("Resulted in Death")
    seriousnesslifethreatening = models.NullBooleanField("Life Threatening")
    seriousnesshospitalization = models.NullBooleanField("Caused/prolonged hospitalization")
    seriousnessdisabling = models.NullBooleanField("Disabling/Incapacitating")
    seriousnesscongenitalanomali = models.NullBooleanField("Congenital anomaly/birth defect")
    seriousnessother = models.NullBooleanField("Other medically important condition")
    ## A.1.6
    ...
    senderorganization = models.CharField("Organization of Sender", max_length=100, blank=True)
    ## A.3.2
    ...
    receiverorganization = models.CharField("Organization of Receiver", max_length=100, blank=True)
    ## B.1
    patientonsetage = models.FloatField("Patient age at onset of adverse event", max_length=100, blank=True, null=True)
...
class Drug(models.Model):
    ...
    drugseparatedosagenumb = models.FloatField("Number of separate dosages", max_length=50, blank=True, null=True)
    drugintervaldosageunitnumb = models.FloatField("Number of units in the interval", max_length=50, blank=True, null=True)
    ...
    drugcumulativedosagenumb = models.FloatField("Cumulative dose to the first reaction", max_length=50, blank=True, null=True)
    ...
    drugdosageform = models.CharField("Pharmaceutical form", max_length=100, blank=True)
    ...
    drugindication = models.CharField("Indication for use in the case", max_length=100, blank=True)
    drugstartdateformat = models.CharField("Date format code", blank=True, max_length=25)
    drugstartdate = models.DateField("Date when patient started taking the drug", blank=True, null=True)
    drugenddateformat = models.CharField("Date format code", blank=True, max_length=25)
    ...
    drugtreatmentduration = models.IntegerField("Duration of drug administration unit", choices=interval_choices, blank=True, null=True)
